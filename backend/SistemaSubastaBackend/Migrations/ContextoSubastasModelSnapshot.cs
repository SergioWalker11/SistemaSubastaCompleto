...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SistemaSubastaBackend.Modelos.DatosBancarios", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SistemaSubastaBackend.Modelos.Denuncia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SistemaSubastaBackend.Modelos.DatosBancarios", b =>
                {
                    b.HasOne("SistemaSubastaBackend.Modelos.Usuario", "Usuario")
                        ...
                        .HasForeignKey("SistemaSubastaBackend.Modelos.DatosBancarios", "UsuarioId")
            ...
            modelBuilder.Entity("SistemaSubastaBackend.Modelos.Denuncia", b =>
                {
                    b.HasOne("SistemaSubastaBackend.Modelos.Usuario", "Denunciado")
                        .WithMany()
                        .HasForeignKey("DenunciadoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SistemaSubastaBackend.Modelos.Usuario", "Denunciante")
                        .WithMany()
            ...
            modelBuilder.Entity("SistemaSubastaBackend.Modelos.Subasta", b =>
                {
                    b.HasOne("SistemaSubastaBackend.Modelos.Usuario", "Ganador")
                        .WithMany()
